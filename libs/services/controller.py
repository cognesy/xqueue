"""Controller supervision services."""
        ...
        *,
        ...
        while True:
            ...
            if requested_state is ControllerState.ACTIVE and state is ControllerState.PAUSED:
                ...
                self._request_worker_state(config=current_config, controller_id=controller_id, state=WorkerState.DRAINING)
            elif requested_state is ControllerState.STOPPING:
                state = ControllerState.STOPPING
                self._request_worker_state(config=current_config, controller_id=controller_id, state=WorkerState.STOPPED)
