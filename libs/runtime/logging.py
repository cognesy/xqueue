"""Structured logging configuration and runtime bootstrap."""
...
import structlog
import yaml
from xqueue.runtime.resources import resource_file
...
def default_logging_config_path() -> Traversable:
...
def configure_logging(level: str | None = None) -> LoggingConfig:
    ...
    structlog.configure(
        ...
        # Route through stdlib so an embedding host that never configures xqueue
        # gets standard library behaviour instead of printed INFO chatter.
