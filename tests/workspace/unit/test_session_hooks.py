...
from xqueue.workspace.hooks import ensure_agent_hooks, inspect_agent_hooks
...
def test_ensure_agent_hooks_creates_repo_local_files(tmp_path: Path, monkeypatch) -> None:
    ...
    monkeypatch.setattr("xqueue.workspace.hooks.resolve_executable", lambda: executable)
